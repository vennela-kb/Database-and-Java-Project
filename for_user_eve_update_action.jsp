<%-- 
    Document   : for_user_eve_update_action
    Created on : Feb 25, 2021, 8:58:21 PM
    Author     : venne
--%>
...
<html>
    ...
    <body>
       <%
        ...
        PreparedStatement ps=con.prepareStatement("update USER_EVENT_ADD set EVENT_TYPE=?, EVENT=?, DATE_OF_EVENT=?,TIME_OF_EVENT=?,ADDRESS_OF_EVENT=?, EMAIL_ID=?,CONTACT_NO=? where EVENT_ID='"+eve_id+"'");
